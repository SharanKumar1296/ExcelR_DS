...
db = DBSCAN(eps=0.60,min_samples=2)  

db.fit(X)

Y = db.labels_ #The labels created after the clustering 
pd.DataFrame(Y).value_counts() # 0   50
